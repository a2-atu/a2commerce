...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 700px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
        <h2 style="color: #1a1a1a; margin-top: 0; border-bottom: 2px solid #e0e0e0; padding-bottom: 10px;">Order Information</h2>
        ...
        <table style="width: 100%; margin-bottom: 20px;">
            ...
            <tr>
                ...
                <td style="padding: 8px 0;"><span style="background-color: #10b981; color: #ffffff; padding: 4px 8px; border-radius: 4px; font-size: 12px; text-transform: uppercase;">{{ ucfirst($order->status) }}</span></td>
            </tr>
            <tr>
                <td style="padding: 8px 0; color: #666;"><strong>Payment Status:</strong></td>
                <td style="padding: 8px 0;"><span style="background-color: #10b981; color: #ffffff; padding: 4px 8px; border-radius: 4px; font-size: 12px; text-transform: uppercase;">{{ ucfirst($order->payment_status) }}</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 8px 0; font-size: 18px; font-weight: bold; color: #dc2626;">{{ config('a2.currency_symbol') }} {{ number_format($order->total, 2) }}</td>
            </tr>
        </table>
    </div>
    ...
    @php
        ...
        $customerName = $order->user ? $order->user->name : ($shippingAddress ? $shippingAddress->first_name . ' ' . $shippingAddress->last_name : 'Guest Customer');
    @endphp

    <div style="background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
        <h2 style="color: #1a1a1a; margin-top: 0; border-bottom: 2px solid #e0e0e0; padding-bottom: 10px;">Customer Information</h2>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 10px; text-align: right; border-bottom: 1px solid #f0f0f0;">{{ config('a2.currency_symbol') }} {{ number_format($item->price, 2) }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td style="padding: 10px; text-align: right; font-weight: bold; font-size: 16px; color: #dc2626; border-top: 2px solid #e0e0e0;">{{ config('a2.currency_symbol') }} {{ number_format($order->total, 2) }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
